#------------------------------------------------------------------
# Check if the directory exists, if not create Data 
# Save the url in fileUrl
# Download the file in the url and save it the destination file
# Datase.zip
#------------------------------------------------------------------
...
#------------------------------------------------------------------
# This module reads the files form the data
#------------------------------------------------------------------
